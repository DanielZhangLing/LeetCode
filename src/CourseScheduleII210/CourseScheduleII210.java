...
//	    return solveByDFS(adjs);
	 ...
	 *  Since it is likely to be sparse,
	 * we use adjacency list graph data structure. 
	...
	/**
	 * We observe that if a node has incoming edges, 
	 * it has prerequisites. Therefore, 
	 * the first few in the order must be those with no prerequisites,
	 ...
	 *    we are left with a smaller DAG, which is the same problem. 
